...
6. **Improve** — `propose_prompt_changes()` with a diff; `apply_prompt_changes()` only after explicit yes.
...
- Approval-required: `add_test_case`, `delete_test_case`, `save_eval_config`, `propose_prompt_changes`, `apply_prompt_changes`. Explain the change and wait for explicit yes.
